<script lang="ts">
  ...
  import { ChevronDownOutline, ChevronRightOutline, PenSolid, DownloadSolid, ShareNodesSolid, TrashBinSolid, DotsHorizontalOutline } from "flowbite-svelte-icons";
...
<Card class="px-4 pb-4 pt-0 bg-transparent dark:bg-transparent border-transparent">
  <div class="flex w-full items-start justify-between">
    <div class="flex-col items-center">
      <div class="mb-1 flex items-center">
        <Popover class="z-10 w-72 rounded-lg border  bg-transparent text-sm text-gray-500 shadow-xs  dark:text-gray-400">
  ...
  <div class="grid grid-cols-1 items-center justify-between">
    <div class="flex items-center justify-between pt-5">
      <Button class="inline-flex items-center bg-transparent py-0 text-center text-sm font-medium text-white hover:bg-transparent focus:ring-transparent dark:bg-transparent dark:focus:ring-transparent">Last 7 days<ChevronDownOutline class="m-2.5 ms-1.5 w-2.5" /></Button>
